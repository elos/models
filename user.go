...
func (user *User) ActionsIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(user.ActionsIDs), store), nil
}

func (user *User) Actions(store data.Store) ([]*Action, error) {
...
func (user *User) Calendar(store data.Store) (*Calendar, error) {
	if user.CalendarID == "" {
...
func (user *User) CurrentActionable(store data.Store) (Actionable, error) {
...
func (user *User) EventsIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(user.EventsIDs), store), nil
}

func (user *User) Events(store data.Store) ([]*Event, error) {
...
func (user *User) Ontology(store data.Store) (*Ontology, error) {
	if user.OntologyID == "" {
		return nil, ErrEmptyLink
	}
...
func (user *User) RoutinesIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(user.RoutinesIDs), store), nil
}

func (user *User) Routines(store data.Store) ([]*Routine, error) {
...
func (user *User) TasksIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(user.TasksIDs), store), nil
}

func (user *User) Tasks(store data.Store) ([]*Task, error) {
