...
func (ontology *Ontology) ClassesIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(ontology.ClassesIDs), store), nil
}

func (ontology *Ontology) Classes(store data.Store) ([]*Class, error) {
...
func (ontology *Ontology) ObjectsIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(ontology.ObjectsIDs), store), nil
}

func (ontology *Ontology) Objects(store data.Store) ([]*Object, error) {
...
func (ontology *Ontology) User(store data.Store) (*User, error) {
	if ontology.UserID == "" {
