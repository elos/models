...
func (calendar *Calendar) BaseSchedule(store data.Store) (*Schedule, error) {
...
func (calendar *Calendar) CurrentFixture(store data.Store) (*Fixture, error) {
...
func (calendar *Calendar) User(store data.Store) (*User, error) {
	if calendar.UserID == "" {
		return nil, ErrEmptyLink
	}
