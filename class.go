...
func (class *Class) Kind() d.Kind {
	return ClassKind
}

// just returns itself for now
func (class *Class) Concerned() []d.ID {
	foo := make([]d.ID, 1)
	foo[0] = class.ID()
	return foo
}

func (class *Class) SetID(id d.ID) {
	class.Id = id.String()
}

func (class *Class) ID() d.ID {
	return d.ID(class.Id)
}
...
func (class *Class) LinksIter(store d.Store) (d.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(class.LinksIDs), store), nil
}

func (class *Class) Links(store d.Store) ([]*Link, error) {
...
func (class *Class) ObjectsIter(store d.Store) (d.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(class.ObjectsIDs), store), nil
}

func (class *Class) Objects(store d.Store) ([]*Object, error) {
...
func (class *Class) Ontology(store d.Store) (*Ontology, error) {
	if class.OntologyID == "" {
...
func (class *Class) TraitsIter(store d.Store) (d.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(class.TraitsIDs), store), nil
}

func (class *Class) Traits(store d.Store) ([]*Trait, error) {
...
func (class *Class) User(store d.Store) (*User, error) {
	if class.UserID == "" {
		return nil, ErrEmptyLink
	}
