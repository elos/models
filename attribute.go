...
func (attribute *Attribute) Kind() d.Kind {
	return AttributeKind
}

// just returns itself for now
func (attribute *Attribute) Concerned() []d.ID {
	foo := make([]d.ID, 1)
	foo[0] = attribute.ID()
	return foo
}

func (attribute *Attribute) SetID(id d.ID) {
	attribute.Id = id.String()
}

func (attribute *Attribute) ID() d.ID {
...
func (attribute *Attribute) Object(store d.Store) (*Object, error) {
...
func (attribute *Attribute) Trait(store d.Store) (*Trait, error) {
