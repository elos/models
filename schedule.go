...
func (schedule *Schedule) FixturesIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(schedule.FixturesIDs), store), nil
}

func (schedule *Schedule) Fixtures(store data.Store) ([]*Fixture, error) {
...
func (schedule *Schedule) User(store data.Store) (*User, error) {
	if schedule.UserID == "" {
