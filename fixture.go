...
func (fixture *Fixture) Actionable(store data.Store) (Actionable, error) {
...
func (fixture *Fixture) ActionsIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(fixture.ActionsIDs), store), nil
}

func (fixture *Fixture) Actions(store data.Store) ([]*Action, error) {
...
func (fixture *Fixture) Eventable(store data.Store) (Eventable, error) {
...
func (fixture *Fixture) EventsIter(store data.Store) (data.ModelIterator, error) {
	// not yet completely general
	return mongo.NewIDIter(mongo.NewIDSetFromStrings(fixture.EventsIDs), store), nil
}

func (fixture *Fixture) Events(store data.Store) ([]*Event, error) {
...
func (fixture *Fixture) User(store data.Store) (*User, error) {
	if fixture.UserID == "" {
		return nil, ErrEmptyLink
	}
